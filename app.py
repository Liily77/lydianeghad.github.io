...
file_path = "wifi_usage_data.csv"
wifi_usage_data = load_data(file_path)
...
if menu == "Origine des données 🔎":
    ...
    with col1:
        st.image("Logo1.PNG", use_column_width=True)  # Charger la première image

    with col2:
        st.image("Logo2.PNG", use_column_width=True)  # Charger la seconde image

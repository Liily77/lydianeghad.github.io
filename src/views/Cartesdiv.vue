<template>
  <div class="home">
    ...
    <!-- FICHES PRODUITS -->
    <div id="cartesdiv-cards" class="products-container">
      <CartesdivProduit
    ...
    <!-- BANNIÈRE -->
    <div class="banner">
      <img src="/assets/images/banner-cartediv.jpg" alt="Bannière Cartes divinatoires" class="banner-img" />
      <div class="banner-text">
        <div class="banner-text-box">
          <p>Explorez l’univers mystique de nos cartes divinatoires.</p>
          <p>Un outil sacré pour vous guider avec intuition et clarté.</p>
        </div>
      </div>
    </div>
  </div>

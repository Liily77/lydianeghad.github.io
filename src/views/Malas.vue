<template>
  <div class="malas-page">
    <!-- TITRE SECTION -->
    <div class="section-title">
      <img src="/assets/images/titre-malas.jpg" alt="Nos Malas" />
    </div>
    ...
    <!-- FICHES PRODUITS -->
    <div id="malas-cards" class="products-container">
      <MalasProduit
    ...
    <!-- BANNIÈRE -->
    <div class="banner">
      <img src="/assets/images/banner-malas.jpg" alt="Bannière Malas" class="banner-img" />
      <div class="banner-text">
        <div class="banner-text-box">
          <p>Découvrez nos malas artisanaux pour méditation, prière et énergie spirituelle.</p>
          <p>Perles naturelles, symboles sacrés et intention pure.</p>
        </div>
      </div>
    </div>
  </div>

<template>
  <div class="bijouxchev-page">
    <!-- TITRE SECTION -->
    <div class="section-title">
      <img src="/assets/images/titre-bijouxchev.jpg" alt="Nos Bijoux de Cheville" />
    </div>
    ...
    <!-- FICHES PRODUITS -->
    <div id="bijouxchev-cards" class="products-container">
      <BijouxchevProduit
    ...
    <!-- BANNIÈRE -->
    <div class="banner">
      <img src="/assets/images/banner-bijouxchev.jpg" alt="Bannière Bijoux de Cheville" class="banner-img" />
      <div class="banner-text">
        <div class="banner-text-box">
          <p>Découvrez notre collection estivale de bijoux de cheville perlés et symboliques.</p>
          <p>Légèreté, charme et spiritualité à vos pas.</p>
        </div>
      </div>
    </div>
  </div>

<template>
  <div class="bracelets-page">
    ...
    <div class="section-title">
      <img src="/assets/images/titre-bracelets.jpg" alt="Nos Bracelets" />
    </div>
    ...
    <!-- BANNIÈRE -->
    <div class="banner">
      <img src="/assets/images/banner-bracelets.jpg" alt="Bannière Bracelets" class="banner-img" />
      <div class="banner-text">
        <div class="banner-text-box">
          <p>Laissez-vous séduire par nos bracelets en pierres naturelles.</p>
          <p>Des créations uniques pour équilibrer énergie et élégance au poignet.</p>
        </div>
      </div>
    </div>
  </div>
